spec三份文档生成
当用户说自己对于CodeForge的新增功能的初步想法的时候,要用「生成spec三份文档的模板生成spec三份文档的模板工作 流」,生成的三份文档放在根目录的docs目录下

生成spec三份文档的模板工作流
我正在构建一个终端 AI 编程助手(类似 Claude Code),项目名叫 CodeForge,使用的编程语言是 python
...
我的初步想法是:[你的想法] 哪些留给后续章节不做:[不做什么] GPI
